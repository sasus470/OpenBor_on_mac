...
int main(int argc, char *argv[])
{
    ...
    apply_env_override(paksDir, sizeof(paksDir), "OPENBOR_PAKS_DIR");
    apply_env_override(savesDir, sizeof(savesDir), "OPENBOR_SAVES_DIR");
    apply_env_override(logsDir, sizeof(logsDir), "OPENBOR_LOGS_DIR");
    apply_env_override(screenShotsDir, sizeof(screenShotsDir), "OPENBOR_SCREENSHOTS_DIR");
